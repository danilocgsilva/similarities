...
from WordCoverage import WordCorevage

class Compare:

    def compare(self, value1: str, value2: str):
        char_coverage = CharConverage()
        ...
        self.__calculate_general_index__(index_char_coverage, index_word_coverage)
    ...
    def __calculate_general_index__(index_char_coverage, index_word_coverage):
        return 100
